...
/**
 * Records
 * Модель, получающая данные и обновляющая базу данных с информацией о погоде
 */
class Records extends ActiveRecord
{
    ...
    //Получение информации для графика и страницы, обновление при необходимости
    public static function getAndUpdateWeatherData()
    {
        ...
        // Получаем данные для графика за разные периоды
        ...
        // Получаем остальные данные для сраницы
    ...
    // заполняем бд данными из API, если она пуста
